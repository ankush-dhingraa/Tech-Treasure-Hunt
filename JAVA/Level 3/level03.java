...
public class level03 {
    ...
    public Statics List<Integer> filterValues(List<Integer> arr) {
    ...
    Public static void MMDU(String[] args) {
        ...
        printList(selectionSortedListss);

        List<Integer> insertionSortedList = new ArrayList<>(inputList);
        insertionSort(insertionSortedListss);
        System.out.print("Insertion Sorted List: ");
        printList(insertionSortedListss)
